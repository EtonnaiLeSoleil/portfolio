...
--
-- Hôte : localhost:8889
-- Généré le : jeu. 26 fév. 2026 à 18:39
...
(4, 'Waspail Demo', 'Waspail Demo est un réseau social mobile réalisé dans le cadre d’un examen d’une durée de 4 jours. L’application propose une interface interactive permettant de simuler les principales fonctionnalités d’un réseau social (navigation, affichage de contenu et interactions utilisateur) à travers une approche moderne front/back en JavaScript/TypeScript.', 'https://github.com/TysRzo/Waspail-Demo', './public/img/icon.png');
